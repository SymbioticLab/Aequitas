...
template = '../simulator 1 ./exp_config/conf_{0}{5}_{1}_{2}_B{3}_{4}.txt > ./result/result_{0}{5}_{1}_{2}_B{3}_{4}.txt'
cdf_temp = './CDF_{}.txt'
            ...
            for burst in burst_size:
                for N in traffic_size:          # incast size or all-to-all size
                    ...
                    if (random_flow_start):
                        isrand = 'rand'
                    confFile = "./exp_config/conf_{0}{5}_{1}_{2}_B{3}_{4}.txt".format(r, cdf, ratio.replace(',', '_'), burst, isrand, N)
