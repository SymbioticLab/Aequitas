#ifndef CORESIM_RANDOM_VARIABLE_H
#define CORESIM_RANDOM_VARIABLE_H
...
class StaticVariable : public RandomVariable {
public:
  virtual double value();
  StaticVariable(double value);
  double val_;
};
...
#endif  // CORESIM_RANDOM_VARIABLE_H
