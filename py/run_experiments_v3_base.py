...
conf_str_incastN_3qos = '''init_cwnd: 2
max_cwnd: 30
retx_timeout: 450
queue_size: 1048576
propagation_delay: 0.0000002
...
qos_ratio = ['10,20,70', '20,20,60', '30,20,50', '40,20,40', '50,20,30', '60,20,20', '70,20,10', '80,10,10']
#qos_ratio = ['70,30']
...
template = binary + ' 1 ./exp_config3_base/conf_{0}{1}_{2}_{3}_B{4}_base.txt > ./result3_base/result_{0}{1}_{2}_{3}_B{4}_base.txt'
cdf_temp = './CDF_{}.txt'
cdf_RPC = ['uniform_32K']
            ...
            for burst in burst_size:
                for N in traffic_size:          # incast size or all-to-all size
                    ...
                    if r == 'incast':
                        ...
                        conf_str = conf_str_incastN_3qos.format(num_flow, cdf, ratio, burst, N + 1)
                    elif r == 'all_to_all':
                    ...
                    confFile = "./exp_config3_base/conf_{0}{1}_{2}_{3}_B{4}_base.txt".format(r, N, cdf, ratio.replace(',', '_'), burst)
