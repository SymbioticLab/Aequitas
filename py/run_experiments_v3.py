...
template = binary + ' 1 ./exp_config6/conf_{0}{1}_{2}_{3}_B{4}_T{5}.txt > ./result6/result_{0}{1}_{2}_{3}_B{4}_T{5}.txt'
cdf_temp = './CDF_{}.txt'
#cdf_RPC = ['uniform_4K', 'uniform_32K']
cdf_RPC = ['uniform_32K']
#cdf_RPC = ['write_req']
#lat_target = [1, 2, 3, 4, 5, 6, 7, 8, 9]
lat_target = [10, 20, 30, 40, 50, 60, 70, 80, 90]
            ...
            for burst in burst_size:
                for N in traffic_size:          # incast size or all-to-all size
                    for target in lat_target:
                        ...
                        #  generate conf file
                        if r == 'incast':
                            conf_str = conf_str_incastN.format(num_flow, cdf, ratio, burst, N + 1, target)
                        elif r == 'all_to_all':
                        ...
                        confFile = "./exp_config6/conf_{0}{1}_{2}_{3}_B{4}_T{5}.txt".format(r, N, cdf, ratio.replace(',', '_'), burst, target)
